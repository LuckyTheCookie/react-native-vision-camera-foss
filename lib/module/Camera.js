...
import { CameraRuntimeError, tryParseNativeCameraError, isErrorWithCause } from "./CameraError.js";
import { CameraModule } from "./NativeCameraModule.js";
import { VisionCameraProxy } from "./frame-processors/VisionCameraProxy.js";
import { CameraDevices } from "./CameraDevices.js";
import { SkiaCameraCanvas } from "./skia/SkiaCameraCanvas.js";
import { FpsGraph, MAX_BARS } from "./FpsGraph.js";
import { NativeCameraView } from "./NativeCameraView.js";
...
export class Camera extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/_jsxs(NativeCameraView, {
      ...props,
      cameraId: device.id,
      ref: this.ref,
      torch: torch,
      ...
      children: [isRenderingWithSkia && /*#__PURE__*/_jsx(SkiaCameraCanvas, {
        style: styles.customPreviewView,
        offscreenTextures: frameProcessor.offscreenTextures,
        resizeMode: props.resizeMode
      }), enableFpsGraph && /*#__PURE__*/_jsx(FpsGraph, {
