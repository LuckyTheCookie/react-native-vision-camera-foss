...
import { WorkletsProxy } from "../dependencies/WorkletsProxy.js";
import { SkiaProxy } from "../dependencies/SkiaProxy.js";
import { withFrameRefCounting } from "../frame-processors/withFrameRefCounting.js";
 ...
 * ```
 */
export function createSkiaFrameProcessor(frameProcessor, surfaceHolder, offscreenTextures, previewOrientation) {
...
export function useSkiaFrameProcessor(frameProcessor, dependencies) {
  ...
  const previewOrientation = WorkletsProxy.useSharedValue('portrait');
  useEffect(() => {
    return () => {
  ...
  return useMemo(() => createSkiaFrameProcessor(frameProcessor, surface, offscreenTextures, previewOrientation),
