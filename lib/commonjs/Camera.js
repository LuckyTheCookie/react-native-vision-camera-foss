...
var _NativeCameraModule = require("./NativeCameraModule.js");
var _VisionCameraProxy = require("./frame-processors/VisionCameraProxy.js");
var _CameraDevices = require("./CameraDevices.js");
var _SkiaCameraCanvas = require("./skia/SkiaCameraCanvas.js");
var _FpsGraph = require("./FpsGraph.js");
var _NativeCameraView = require("./NativeCameraView.js");
var _RotationHelper = require("./RotationHelper.js");
...
class Camera extends _react.default.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_NativeCameraView.NativeCameraView, {
      ...props,
      cameraId: device.id,
      ref: this.ref,
      torch: torch,
      ...
      children: [isRenderingWithSkia && /*#__PURE__*/(0, _jsxRuntime.jsx)(_SkiaCameraCanvas.SkiaCameraCanvas, {
        style: styles.customPreviewView,
        offscreenTextures: frameProcessor.offscreenTextures,
        resizeMode: props.resizeMode
      }), enableFpsGraph && /*#__PURE__*/(0, _jsxRuntime.jsx)(_FpsGraph.FpsGraph, {
