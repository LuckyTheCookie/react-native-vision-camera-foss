...
var _ReanimatedProxy = require("../dependencies/ReanimatedProxy.js");
var _SkiaProxy = require("../dependencies/SkiaProxy.js");
...
function SkiaCameraCanvasImpl({
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_SkiaProxy.SkiaProxy.Canvas, {
    ...props,
    onLayout: onLayout,
    pointerEvents: "none",
    children: [children, /*#__PURE__*/(0, _jsxRuntime.jsx)(_SkiaProxy.SkiaProxy.Image, {
      x: 0,
      y: 0,
      width: width,
      height: height,
